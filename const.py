...
DATA_DOC_FAIRSEQ_PATH = DATA_PATH + 'fairseq.doc-doc/'
DATA_DOC_TRAIN_FAIRSEQ_PATH = DATA_DOC_FAIRSEQ_PATH + 'train.doc'
DATA_DOC_TEST_FAIRSEQ_PATH = DATA_DOC_FAIRSEQ_PATH + 'test.doc'
DATA_DOC_VALID_FAIRSEQ_PATH = DATA_DOC_FAIRSEQ_PATH + 'valid.doc'
DATA_CODE_FAIRSEQ_PATH = DATA_PATH + 'fairseq.code-code/'
DATA_CODE_TRAIN_FAIRSEQ_PATH = DATA_CODE_FAIRSEQ_PATH + 'train.code'
DATA_CODE_TEST_FAIRSEQ_PATH = DATA_CODE_FAIRSEQ_PATH + 'test.code'
DATA_CODE_VALID_FAIRSEQ_PATH = DATA_CODE_FAIRSEQ_PATH + 'valid.code'
