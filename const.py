...
DATA_FAIRSEQ_PATH = DATA_PATH + 'fairseq.code-code/'
DATA_TRAIN_FAIRSEQ_PATH = DATA_FAIRSEQ_PATH + 'train.code'
DATA_TEST_FAIRSEQ_PATH = DATA_FAIRSEQ_PATH + 'test.code'
DATA_VALID_FAIRSEQ_PATH = DATA_FAIRSEQ_PATH + 'valid.code'
